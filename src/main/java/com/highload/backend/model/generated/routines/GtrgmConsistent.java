...
public class GtrgmConsistent extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>backend.gtrgm_consistent.RETURN_VALUE</code>.
     */
    ...
    public GtrgmConsistent() {
        super("gtrgm_consistent", Backend.BACKEND, SQLDataType.BOOLEAN);
