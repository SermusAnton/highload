...
public class WordSimilarityDistOp extends AbstractRoutine<Float> {
    ...
    public WordSimilarityDistOp() {
        super("word_similarity_dist_op", Backend.BACKEND, SQLDataType.REAL);
