...
public class SimilarityDist extends AbstractRoutine<Float> {
    ...
    public SimilarityDist() {
        super("similarity_dist", Backend.BACKEND, SQLDataType.REAL);
